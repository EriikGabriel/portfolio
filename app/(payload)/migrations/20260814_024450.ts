...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "about" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"image_id" integer,
  	"greeting" varchar DEFAULT 'Olá,' NOT NULL,
  	"description" varchar NOT NULL,
  ...
  ALTER TABLE "tags" ADD CONSTRAINT "tags_tech_id_techs_id_fk" FOREIGN KEY ("tech_id") REFERENCES "public"."techs"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "about_rels" ADD CONSTRAINT "about_rels_techs_fk" FOREIGN KEY ("techs_id") REFERENCES "public"."techs"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "techs__order_idx" ON "techs" USING btree ("_order");
  CREATE UNIQUE INDEX "techs_name_idx" ON "techs" USING btree ("name");
  CREATE INDEX "techs_updated_at_idx" ON "techs" USING btree ("updated_at");
  CREATE INDEX "techs_created_at_idx" ON "techs" USING btree ("created_at");
  ...
  CREATE UNIQUE INDEX "tags_tech_idx" ON "tags" USING btree ("tech_id");
  ...
  CREATE INDEX "payload_locked_documents_rels_techs_id_idx" ON "payload_locked_documents_rels" USING btree ("techs_id");
  ...
  CREATE INDEX "about_rels_techs_id_idx" ON "about_rels" USING btree ("techs_id");`)
}
