...
export const EvervaultCard = ({
  ...
  useEffect(() => {
    let str = generateRandomString(strSize);
    setRandomString(str);
  }, []);
...
export function CardPattern({ mouseX, mouseY, randomString }: any) {
  ...
  return (
    <div className="pointer-events-none">
      ...
      <motion.div
        className="absolute inset-0 rounded-2xl bg-gradient-to-r from-orange-500 to-neutral-700 opacity-0  backdrop-blur-xl transition duration-500 group-hover/card:opacity-100"
        style={style}
      />
      <motion.div
