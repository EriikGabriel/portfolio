...
export const Lamp = ({
	...
	return (
		...
		>
			{(title || subtitle) && (
				<div className="relative top-0 z-10 bg-linear-to-br from-slate-300 to-slate-500 bg-clip-text py-4 text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl">
